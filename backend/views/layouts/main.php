        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme ms-3 mt-4 rounded" style="height: 90vh; position: fixed;">
          ...
          <ul class="menu-inner py-1 ">
            ...
            <li class="menu-item <?php if(str_contains(Url::current(), 'signup')):?><?= 'active'?><?php endif;?>">
              <a class="menu-link" href="http://localhost/advancedsearch/advanced/frontend/web/index.php?r=site%2Fsignup"><i class="fa-solid fa-user-plus me-2"></i><div data-i18n="Analytics">Sign Up User</div></a>
            </li>
